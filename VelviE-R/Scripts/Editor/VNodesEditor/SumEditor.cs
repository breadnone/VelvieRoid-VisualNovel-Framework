...
namespace VIEditor
{
    [CustomEditor(typeof(Sum))]
    public class SumEditor : Editor
    {
        ...
        private VisualElement DrawToggle(Sum t)
        {
        ...
        private VisualElement DrawVars(Sum t)
        {
        ...
        private void DrawLocalVars(Sum t)
        {
        ...
        private void DrawAnyType(Sum t)
        {
            if (t.variable != null)
                RemoveChild();
