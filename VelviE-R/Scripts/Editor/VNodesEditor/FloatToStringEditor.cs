...
namespace VIEditor
{
    [CustomEditor(typeof(FloatToString))]
    public class FloatToStringEditor : Editor
    {
        ...
        private VisualElement DrawAppend(FloatToString t)
        {
        ...
        private VisualElement DrawVars(FloatToString t)
        {
        ...
        private VisualElement DrawType(FloatToString t)
        {
