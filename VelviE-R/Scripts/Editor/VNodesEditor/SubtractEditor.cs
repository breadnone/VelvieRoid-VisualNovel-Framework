...
namespace VIEditor
{
    ...
    public class SubtractEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var t = target as Subtract;
            t.mathBasics = MathBasic.Subtract;
        ...
        private VisualElement DrawToggle(Subtract t)
        {
        ...
        private VisualElement DrawVars(Subtract t)
        {
        ...
        private void DrawLocalVars(Subtract t)
        {
        ...
        private void DrawAnyType(Subtract t)
        {
            if (t.variable != null)
                RemoveChild();
