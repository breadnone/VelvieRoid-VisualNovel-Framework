...
namespace VIEditor
{
    [CustomEditor(typeof(DoubleToString))]
    public class DoubleToStringEditor : Editor
    {
        ...
        private VisualElement DrawAppend(DoubleToString t)
        {
        ...
        private VisualElement DrawVars(DoubleToString t)
        {
        ...
        private VisualElement DrawType(DoubleToString t)
        {
