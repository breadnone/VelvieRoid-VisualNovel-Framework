...
namespace VIEditor
{
    [CustomEditor(typeof(Vector3Distance))]
    public class Vector3DistanceEditor : Editor
    {
        public override VisualElement CreateInspectorGUI()
        {
            var root = new VisualElement();
            var t = target as Vector3Distance;
        ...
        private VisualElement DrawVars(Vector3Distance t)
        {
        ...
        private VisualElement DrawObject(Vector3Distance t)
        {
        ...
        private VisualElement DrawObjectTo(Vector3Distance t)
        {
