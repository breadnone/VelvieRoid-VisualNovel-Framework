...
namespace VIEditor
{
    [CustomEditor(typeof(Divide))]
    public class DivideEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var t = target as Divide;
            t.mathBasics = MathBasic.Divide;
        ...
        private VisualElement DrawToggle(Divide t)
        {
        ...
        private VisualElement DrawVars(Divide t)
        {
        ...
        private void DrawLocalVars(Divide t)
        {
        ...
        private void DrawAnyType(Divide t)
        {
            if (t.variable != null)
                RemoveChild();
            ...
            if (t.variable is VBoolean && t.anyType.type == VTypes.Boolean)
            {
                ...
                var vas = new Toggle();
                vas.style.width = new StyleLength(new Length(40, LengthUnit.Percent));
                vis.Add(vas);
